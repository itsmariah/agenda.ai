...
CREATE TABLE "Conversation" (
    ...
    "userId" TEXT,
    "establishmentId" TEXT NOT NULL,
    "context" TEXT NOT NULL DEFAULT 'CLIENT',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_establishmentId_fkey" FOREIGN KEY ("establishmentId") REFERENCES "Establishment"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
